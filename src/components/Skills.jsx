...
import tailwind from "../assets/logo/Tailwind_CSS_Logo.webp";
import javaimg from "../assets/logo/java.png";
import cplusimg from "../assets/logo/C++_Logo.webp";
import pyimg from "../assets/logo/python-logo.png";
import cimg from "../assets/logo/cimg.png";
import git from "../assets/logo/git-icon.webp";
import vs from "../assets/logo/vs.webp";
...
items: [
  ...
  return (
    <>
    <h1 className="flex justify-center text-4xl mb-10 font-bold font-serif">Skills</h1>
